...
public class CumparareRepository implements Repository<Integer, Cumparare>{
    private JdbcUtils dbUtils;
    private CasierRepository casierRepo;
    private SpectacolRepository spectacolRepo;
    private static final Logger logger = LogManager.getLogger();

    public CumparareRepository(Properties props, CasierRepository casierRepo, SpectacolRepository spectacolRepo){
